...
const CardProject = ({ title,  imageUrl, iconUrl = "/icons/MagnifyingGlass.svg", url = "#", handleClick }: Props) => {
    const [isHovered, setIsHovered] = React.useState(false);

    return (
        <div
            className="relative cursor-pointer border h-72 bg-gray-100 border-gray-200 rounded-md shadow-lg w-full h-260px overflow-hidden transition-transform duration-300 ease-in-out transform hover:scale-105"
